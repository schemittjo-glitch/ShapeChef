      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            {uncheckedItems} pendentes • {checkedItems} comprados
          </p>
        </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-2.5">
          <input
            type="text"
            required
            placeholder="Nome do item (ex: Peito de frango, Whey, Ovos...)"
            value={newItemName}
          ...
          <input
            type="text"
            placeholder="Quantidade (ex: 1kg, 2 un)"
            value={newItemAmount}
      ...
      {totalItems === 0 ? (
        <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center space-y-2 shadow-sm">
          ...
          <p className="text-xs text-slate-500 max-w-sm mx-auto">
            Você pode adicionar ingredientes diretamente das receitas ou criar sua lista avulsa acima!
          </p>
        </div>
      ) : (
              ...
              >
                <div className="bg-slate-50 px-4 py-3 border-b border-slate-200 flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-slate-500 font-medium">
                    {items.filter((i) => !i.checked).length} restantes
                  </span>
                </div>
